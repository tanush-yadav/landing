...
import Navigation from '@/components/legacy-home/navigation'
import Hero from '@/components/legacy-home/hero'
import { CTASection } from '@/components/legacy-home/cta-section'

// Lazy load heavy components
const InteractiveDemoWrapper = dynamic(
  () => import('@/components/legacy-home/interactive-demo-wrapper'),
  {
    loading: () => (
...
const TeamsSection = dynamic(() => import('@/components/legacy-home/teams-section'), {
  loading: () => (
