...
import { ArrowLeft, BookmarkSimple, Heart, Share } from '@phosphor-icons/react';
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {relatedPosts.map((relatedPost) => (
                  ...
                  >
                    ...
                    <h3 className="font-display text-lg font-semibold text-gray-900 group-hover:text-blue-600 transition-colors mb-2">
                      {relatedPost.title}
                    </h3>
