  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 py-16 sm:py-20">
      ...
      <div className="absolute inset-0 -z-20 pointer-events-none">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-white/85 via-white/45 to-blue-50/40" />

        {/* Glass texture layer */}
        <div className="absolute inset-0 bg-gradient-to-tr from-white/35 via-transparent to-white/15" />
      ...
      <div className="absolute inset-0 -z-[5] bg-gradient-to-b from-transparent via-white/10 to-transparent backdrop-blur-[0.5px] pointer-events-none" />
