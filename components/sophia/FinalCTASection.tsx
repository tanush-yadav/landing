...
import SophiaCharacter from './SophiaCharacter'
...
export default function FinalCTASection() {
  ...
  return (
    <motion.section 
      className="py-32 bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 relative overflow-hidden" 
      ref={containerRef}
